...
namespace WPFComputationalGeometry.Source.Models
{
    public struct LineSegment
    {
        ...
        public bool IntersectsStrict(LineSegment that) // nie uwzględnia stykających się wierzchołków
        {
            ...
            return 
                Line.Contains(p) 
                    && (Math.Abs(MinXRounded - MaxXRounded) < DoubleExtensions.TOLERANCE ? pXRounded >= MinXRounded : pXRounded > MinXRounded)
                    && (Math.Abs(MinXRounded - MaxXRounded) < DoubleExtensions.TOLERANCE ? pXRounded <= MaxXRounded : pXRounded < MaxXRounded)
                    && (Math.Abs(MinYRounded - MaxYRounded) < DoubleExtensions.TOLERANCE ? pYRounded >= MinYRounded : pYRounded > MinYRounded)
                    && (Math.Abs(MinYRounded - MaxYRounded) < DoubleExtensions.TOLERANCE ? pYRounded <= MaxYRounded : pYRounded < MaxYRounded)
                && that.Line.Contains(p) 
                    && (Math.Abs(thatMinXRounded - thatMaxXRounded) < DoubleExtensions.TOLERANCE ? pXRounded >= thatMinXRounded : pXRounded > thatMinXRounded)
                    && (Math.Abs(thatMinXRounded - thatMaxXRounded) < DoubleExtensions.TOLERANCE ? pXRounded <= thatMaxXRounded : pXRounded < thatMaxXRounded)
                    && (Math.Abs(thatMinYRounded - thatMaxYRounded) < DoubleExtensions.TOLERANCE ? pYRounded >= thatMinYRounded : pYRounded > thatMinYRounded)
                    && (Math.Abs(thatMinYRounded - thatMaxYRounded) < DoubleExtensions.TOLERANCE ? pYRounded <= thatMaxYRounded : pYRounded < thatMaxYRounded);
        }
